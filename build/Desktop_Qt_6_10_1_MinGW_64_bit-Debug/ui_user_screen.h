...
"}"));
        ...
        Review_Button = new QPushButton(centralwidget);
        Review_Button->setObjectName("Review_Button");
        Review_Button->setMinimumSize(QSize(280, 30));
        Review_Button->setStyleSheet(QString::fromUtf8("QPushButton\n"
"{\n"
"	color:WHITE;\n"
"	background-color:rgb(42, 42, 42);\n"
"	border:none;\n"
...
"}"));
        ...
        horizontalLayout->addWidget(Review_Button);
...
"}"));
    ...
    void retranslateUi(QMainWindow *User_Screen)
    {
        ...
        Review_Button->setText(QCoreApplication::translate("User_Screen", "Submit Paper for Review", nullptr));
